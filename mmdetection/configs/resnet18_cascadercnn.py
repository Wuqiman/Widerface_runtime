...
test_cfg = dict(
    rpn=dict(
        ...
        min_bbox_size=0),
    rcnn=dict(
        score_thr=1e-3, nms=dict(type='nms', iou_thr=0.5), max_per_img=750),
...
data = dict(
    ...
    val=dict(
        ...
        img_scale=(1300, 800),
        #img_scale=[(750, 500),(1300, 800),(2560, 1700),(1656, 1100),(2108, 1400)],
        img_norm_cfg=img_norm_cfg,
        size_divisor=32,
        flip_ratio=1,
        with_mask=False,
    ...
    test=dict(
        ...
        img_prefix=data_root + 'WIDER_val/images/',
        img_scale=(1300, 800),
        #img_scale=[(999, 800),(1374, 1100),(1748, 1400),(2123, 1700)],
        img_norm_cfg=img_norm_cfg,
        size_divisor=32,
        flip_ratio=0.0,
        with_mask=False,
...
log_level = 'INFO'
work_dir = './work_dirs/widerface_resnet50_bnnofix_ratio1.25'
load_from = None
resume_from = None
workflow = [('train', 1)]
